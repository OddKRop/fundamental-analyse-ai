...
export default async function AnalyseIndexPage() {
    ...
    <div>
      ...
      {analyses.length === 0 ? (
        <div className="text-center py-20 text-zinc-400">
          ...
          <p className="text-sm">
            Kjør <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-zinc-600">node scripts/refresh.mjs</code> for å generere analyser.
          </p>
        </div>
      ) : (
